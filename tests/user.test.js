...
describe('User Controller - store', () => {
  ...
  // Test for `middlewares`
  describe('Middleware - validateUser', () => {
    it('should return 400 if validation fails', () => {
      const mockReq = {
        body: { email: 'invalid-email', age: -5 }, // Input tidak valid
      };
      const mockRes = {
        status: jest.fn().mockReturnThis(),
        json: jest.fn(),
      ...
      validateUser[validateUser.length - 1](mockReq, mockRes, mockNext);
  ...
  describe('store', () => {
    it('should create a new user', async () => {
      ...
      const savedUser = { id: v4(), name: 'John Doe', email: 'john@example.com', age: 25 };
